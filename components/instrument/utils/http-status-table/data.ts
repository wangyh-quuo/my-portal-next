export const httpStatusTableDataSource = [
  {
    column0: "状态码",
    column1: "含义",
  },
  ...
  {
    column0: "102",
    column1: "由WebDAV（RFC 2518）扩展的状态码，代表处理将被继续执行。",
  },
  {
    column0: "200",
    column1: "请求已成功，请求所希望的响应头或数据体将随此响应返回。",
  },
  {
    column0: "201",
    column1:
  ...
  {
    column0: "306",
    column1: "在最新版的规范中，306状态码已经不再被使用。",
  },
  {
    column0: "307",
    column1:
  ...
  {
    column0: "426",
    column1: "客户端应当切换到TLS/1.0。（RFC 2817）",
  },
  {
    column0: "449",
    column1: "由微软扩展，代表请求应当在执行完适当的操作后进行重试。",
  },
  {
    column0: "500",
    column1:
  ...
  {
    column0: "509",
    column1: "服务器达到带宽限制。这不是一个官方的状态码，但是仍被广泛使用。",
  },
  {
    column0: "510",
    column1: "获取资源所需要的策略并没有没满足。（RFC 2774）",
  },
];
